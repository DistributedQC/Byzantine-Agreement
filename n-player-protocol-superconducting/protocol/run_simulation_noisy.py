...
def run():
    ...
    with open("noisy_simulation_2_results.txt", "a") as file:
        file.write(f"M={M}, N={N}, T1_INTERVALS = 1 / {int(T1_TIME / NOISE_TIME)} Loyal_Aborts={incorrect_decisions} | Lieutenant Decisions = {lieutenant_decisions}\n")
